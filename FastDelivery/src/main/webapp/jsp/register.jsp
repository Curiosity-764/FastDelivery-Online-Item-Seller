    ...
    <div class="container">
        <div class="register-card">
            ...
            <div class="text-center">
                ...
                <a href="${pageContext.request.contextPath}/auth/login" class="btn btn-outline-primary w-100 mt-2">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        console.log('Confirm Password length:', document.getElementById('confirmPassword').value.length);
    });
});
</script>
