...
<body>
                    ...
                    <div class="card-body">
                        ...
                        <form action="${pageContext.request.contextPath}/checkout" method="post" id="checkoutForm">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <c:if test="${not empty user.address}">
                                                    <p class="mb-0"><strong>Current Address:</strong> ${user.address}</p>
                                                </c:if>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="form-text">Please provide complete address for delivery</div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="form-check mb-2">
                                    ...
                                    <div class="form-text ms-4">Pay when you receive your order</div>
                                </div>
                            ...
                            <button type="submit" class="btn btn-success btn-lg w-100 py-3" id="placeOrderBtn">
                                <i class="fas fa-lock me-2"></i> Place Order & Pay
                            </button>
                            
                            <div class="text-center mt-3">
                                <small class="text-muted">
                                    <i class="fas fa-shield-alt me-1"></i> Secure checkout · Your information is safe
                                </small>
                            </div>
                        </form>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="order-summary">
                    ...
                    <div class="mb-3">
                        ...
                        <c:forEach var="item" items="${cart.items}">
                            <div class="d-flex justify-content-between mb-2 border-bottom pb-2">
                                <div>
                                    <span class="small">${item.product.product_name} × ${item.quantity}</span>
                                </div>
                    ...
                    <div class="mb-2">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            <span>Shipping</span>
                            <span class="${cart.totalPrice >= 50 ? 'text-success' : ''}">
                                <c:choose>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <h4 class="text-success" id="orderTotal">
                            $${String.format("%.2f", cart.totalPrice + (cart.totalPrice >= 50 ? 0 : 5) + (cart.totalPrice * 0.1))}
                        </h4>
                    </div>
                    
                    <!-- Delivery Estimate -->
                    <div class="alert alert-info mb-4">
                        <h6><i class="fas fa-shipping-fast"></i> Estimated Delivery</h6>
    ...
    <script>
        ...
        window.addEventListener('load', function() {
            ...
            if (savedAddress && !document.getElementById('shippingAddress').value) {
